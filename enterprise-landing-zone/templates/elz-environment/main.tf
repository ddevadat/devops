...
module "network" {
  ...
  is_baseline_deploy                = var.is_baseline_deploy
  enable_shared_tools               = var.enable_shared_tools
  shared_tools_subnets_cidr_blocks  = var.enable_shared_tools ? concat([var.shared_tools_subnet1_cidr_block], var.shared_tools_subnet2_cidr_block != "" ? [var.shared_tools_subnet2_cidr_block] : [], var.shared_tools_subnet3_cidr_block != "" ? [var.shared_tools_subnet3_cidr_block] : [], var.shared_tools_subnet4_cidr_block != "" ? [var.shared_tools_subnet4_cidr_block] : []) : []
