...
variable "newenv_hub_vcn_cidr_block" {
  type        = string
  description = "newenv Enivornment HUB VCN CIDR Block."
}

variable "newenv_hub_public_subnet_cidr_block" {
  type        = string
  description = "newenv Enivornment HUB Public Subnet CIDR Block."
}

variable "newenv_hub_private_subnet_cidr_block" {
  type        = string
  description = "newenv Enivornment HUB Private Subnet CIDR Block."
}

variable "newenv_shared_tools_vcn_cidr_block" {
  type        = string
  description = "newenv Shared Tools VCN CIDR Block."
  default     = ""
}

variable "newenv_shared_tools_subnet1_cidr_block" {
  type        = string
  description = "newenv shared tools Subnet1 CIDR Block."
  default     = ""
}

variable "newenv_shared_tools_subnet2_cidr_block" {
  type        = string
  description = "newenv shared tools Subnet2 CIDR Block."
  default     = ""
}

variable "newenv_shared_tools_subnet3_cidr_block" {
  type        = string
  description = "newenv shared tools Subnet3 CIDR Block."
  default     = ""
}

variable "newenv_shared_tools_subnet4_cidr_block" {
  type        = string
  description = "newenv shared tools Subnet4 CIDR Block."
  default     = ""
}

variable "newenv_shared_tools_vcn_display_name" {
  type        = string
  description = "Shared Tools VCN Display Name"
  default     = ""
}
variable "newenv_shared_tools_vcn_dns_label" {
  description = "A DNS label for the Shared Tools VCN"
  type        = string
  default     = ""
}
variable "newenv_shared_tools_subnet1_dns_label" {
  description = "A DNS label for the Shared Tools VCN's Subnet1"
  type        = string
  default     = ""
}
variable "newenv_shared_tools_subnet2_dns_label" {
  description = "A DNS label for the Shared Tools VCN's Subnet2"
  type        = string
  default     = ""
}
variable "newenv_shared_tools_subnet3_dns_label" {
  description = "A DNS label for the Shared Tools VCN's Subnet3"
  type        = string
  default     = ""
}
variable "newenv_shared_tools_subnet4_dns_label" {
  description = "A DNS label for the Shared Tools VCN's Subnet4"
  type        = string
  default     = ""
}
variable "newenv_enable_tools_internet_gateway" {
  type        = string
  default     = false
  description = "Option to enable true and Disable false."
}
variable "newenv_enable_tools_nat_gateway" {
  type        = string
  default     = true
  description = "Option to enable true and Disable false."
}

variable "newenv_enable_tools_service_gateway" {
  type        = string
  default     = true
  description = "Option to enable true and Disable false."
}
...
variable "newenv_enable_tagging" {
  type        = bool
  default     = false
  description = "Option to enable Tagging gateway in newenv environment"
}

variable "newenv_cost_center_tagging" {
  type        = string
  description = "newenv Cost Center."
  default = ""
}

variable "newenv_geo_location_tagging" {
  type        = string
  description = "newenv Geo Center."
  default = ""
}
...
variable "newenv_shared_tools_workload_subnets_cidr_blocks" {
  type        = list(string)
  default     = []
  description = "A list of subnets cidr blocks in additional workload stack in newenv that needs access to shared tools"
}
