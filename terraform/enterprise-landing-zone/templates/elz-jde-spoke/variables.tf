...
variable "shared_tools_subnets_cidr_blocks" {
  type        = list(string)
  default     = []
  description = "A list of subnets cidr blocks of Shared Tools VCN"
}

variable "enabled_shared_tools" {
  type        = bool
  description = "Set to true if management tools compartment was created during ELZ deployment."
  default     = true
}
