...
module "newenv_environment" {
  ...
  shared_tools_subnet1_cidr_block = var.newenv_shared_tools_subnet1_cidr_block
  shared_tools_subnet2_cidr_block = var.newenv_shared_tools_subnet2_cidr_block
  shared_tools_subnet3_cidr_block = var.newenv_shared_tools_subnet3_cidr_block
  shared_tools_subnet4_cidr_block = var.newenv_shared_tools_subnet4_cidr_block
  shared_tools_vcn_display_name   = var.newenv_shared_tools_vcn_display_name
  shared_tools_vcn_dns_label      = var.newenv_shared_tools_vcn_dns_label
  shared_tools_subnet1_dns_label  = var.newenv_shared_tools_subnet1_dns_label
  shared_tools_subnet2_dns_label  = var.newenv_shared_tools_subnet2_dns_label
  shared_tools_subnet3_dns_label  = var.newenv_shared_tools_subnet3_dns_label
  shared_tools_subnet4_dns_label  = var.newenv_shared_tools_subnet4_dns_label
  ...
  enable_drg_rpc                    = var.newenv_enable_drg_rpc

  #  remote_peering_connection_peer_id          = module.prod_environment.rpc_id
  ...
  shared_tools_workload_subnets_cidr_blocks = var.newenv_shared_tools_workload_subnets_cidr_blocks
