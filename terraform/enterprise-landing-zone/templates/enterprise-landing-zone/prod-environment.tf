...
module "prod_environment" {
  ...
  shared_tools_vcn_cidr_block     = var.prod_shared_tools_vcn_cidr_block
  shared_tools_subnet1_cidr_block = var.prod_shared_tools_subnet1_cidr_block
  shared_tools_subnet2_cidr_block = var.prod_shared_tools_subnet2_cidr_block
  shared_tools_subnet3_cidr_block = var.prod_shared_tools_subnet3_cidr_block
  shared_tools_subnet4_cidr_block = var.prod_shared_tools_subnet4_cidr_block
  shared_tools_vcn_display_name   = var.prod_shared_tools_vcn_display_name
  shared_tools_vcn_dns_label      = var.prod_shared_tools_vcn_dns_label
  shared_tools_subnet1_dns_label  = var.prod_shared_tools_subnet1_dns_label
  shared_tools_subnet2_dns_label  = var.prod_shared_tools_subnet2_dns_label
  shared_tools_subnet3_dns_label  = var.prod_shared_tools_subnet3_dns_label
  shared_tools_subnet4_dns_label  = var.prod_shared_tools_subnet4_dns_label

  enable_dmz = var.prod_enable_dmz
  ...
  enable_drg_rpc                    = var.prod_enable_drg_rpc
  ...
  shared_tools_workload_subnets_cidr_blocks = var.prod_shared_tools_workload_subnets_cidr_blocks
