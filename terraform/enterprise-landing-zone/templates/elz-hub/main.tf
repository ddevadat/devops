locals {
  ...
  # shared_tools_subnets_cidr_blocks        = var.shared_tools_subnets_cidr_blocks != [] ? var.shared_tools_subnets_cidr_blocks : []
  ...
  hub_public_route_rules_options = {
    ...
    route_rules_shared_tools = {
      for index, route in var.shared_tools_subnets_cidr_blocks : "shared-tools-rule-${index}" => {
        network_entity_id = module.drg.drg_id
        destination       = route
        destination_type  = "CIDR_BLOCK"
      }
  ...
  hub_public_route_rules = {
    ...
    route_rules = merge(local.hub_public_route_rules_options.route_rules_igw,
      local.hub_public_route_rules_options.route_rules_vpn,
      local.hub_public_route_rules_options.route_rules_fastconnect,
      local.hub_public_route_rules_options.route_rules_workload,
    local.hub_public_route_rules_options.route_rules_shared_tools)
  }
  ...
  hub_private_route_rules = {
    ...
    route_rules = merge(local.hub_private_route_rules_options.route_rules_nat,
      local.hub_private_route_rules_options.route_rules_srvc_gw,
      local.hub_private_route_rules_options.route_rules_vpn,
      local.hub_private_route_rules_options.route_rules_fastconnect,
      local.hub_private_route_rules_options.route_rules_workload,
    local.hub_private_route_rules_options.route_rules_shared_tools)
  }
